...
export const LogoXAI = ({ size = 16 }: { size?: number }) => {
  return (
    ...
    >
      ...
      <path
        d="M5.5 5.5L8 8L10.5 10.5M10.5 5.5L8 8L5.5 10.5"
        stroke="white"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export const LogoOllama = ({ size = 16 }: { size?: number }) => {
  return (
    <svg
      height={size}
      strokeLinejoin="round"
    ...
    >
      ...
      <path
        d="M5.5 10C5.5 10 6.5 11 8 11C9.5 11 10.5 10 10.5 10"
        stroke="white"
        strokeWidth="1"
        strokeLinecap="round"
      />
...
export const LogoWebLLM = ({ size = 16 }: { size?: number }) => {
  return (
    <svg
      height={size}
      strokeLinejoin="round"
    ...
    >
      <rect
        ...
        strokeWidth="1.5"
      />
      <rect x="1" y="3" width="14" height="3" rx="2" fill="currentColor" />
      ...
      <path
        ...
        fill="none"
      />
      <rect x="9.5" y="9" width="3" height="1" fill="currentColor" />
      <rect x="9.5" y="10.5" width="2" height="1" fill="currentColor" />
    </svg>
  );
};
